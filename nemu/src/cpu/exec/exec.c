...
opcode_entry opcode_table [512] = {
  ...
  /* 0x24 */	IDEXW(I2a,and,1), IDEXW(I2a,and,4), EMPTY, EMPTY,
  /* 0x28 */	IDEXW(G2E,sub,1), IDEXW(G2E,sub,0), IDEXW(E2G,sub,1), IDEXW(E2G,sub,0),
  /* 0x2c */	IDEXW(I2a,sub,1), IDEXW(I2a,sub,4), EMPTY, EMPTY,
  /* 0x30 */	IDEXW(G2E,xor,1), IDEXW(G2E,xor,0), IDEXW(E2G,xor,1), IDEXW(E2G,xor,0),
  /* 0x34 */	IDEXW(I2a,xor,1), IDEXW(I2a,xor,4), EMPTY, EMPTY,
  /* 0x38 */	IDEXW(G2E,cmp,1), IDEXW(G2E,cmp,4), IDEXW(E2G,cmp,1), IDEXW(E2G,cmp,4),
  /* 0x3c */	IDEXW(I2a,cmp,1), IDEXW(I2a,cmp,4), EMPTY, EMPTY,
  ...
  /* 0x68 */	IDEX(I,push), IDEX(SI_E2G,imul3), IDEXW(I,push,1), IDEX(SI_E2G,imul3),
  ...
  /* 0x84 */ IDEXW(G2E,test,1), IDEXW(G2E,test,0), IDEXW(G2E,nop,1), IDEX(G2E,nop),
  /* 0x88 */	IDEXW(mov_G2E, mov, 1), IDEX(mov_G2E, mov), IDEXW(mov_E2G, mov, 1), IDEX(mov_E2G, mov),
  /* 0x8c */	EMPTY,IDEXW(lea_M2G,lea,0), EMPTY, IDEX(E,pop),
  /* 0x90 */	EXW(nop,0), IDEX(E2G,nop), IDEX(E2G,nop), IDEX(E2G,nop),
  /* 0x94 */  IDEX(E2G,nop), IDEX(E2G,nop), IDEX(E2G,nop), IDEX(E2G,nop),
  ...
  /* 0xe4 */	IDEXW(in_I2a,in,1), IDEXW(in_I2a,in,1), IDEXW(out_a2I,out,1), IDEXW(out_a2I,out,4),
  /* 0xe8 */	IDEXW(I,call,0), IDEX(J,jmp), IDEX(J,jmp), IDEXW(J,jmp,1),
  /* 0xec */	IDEXW(in_dx2a,in,2), IDEXW(in_dx2a,in,2), IDEXW(out_a2dx,out,1), IDEXW(out_a2dx,out,4),
